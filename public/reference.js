...
var codeAddress = function() {
  ...
  var getUberdata = function(){
      ...
      var uberReq = $http.get('https://rubyline.herokuapp.com/fares/uber?lat1='+a+ '&long1=' +b+ '&lat2=' + c + '&long2=' +d+ '&riders=' + peeps)
        ...
        var bikeReq = $http.get('https://rubyline.herokuapp.com/estimates/bike?lat='+a+'&long='+b)
  ...
  var getMetrodata = function(){
    ...
    var peeps = document.getElementById("people").value
   var mtrReq = $http.get('https://rubyline.herokuapp.com/fares/train?lat1='+a+'&long1=' +b+ '&lat2=' +c+ '&long2='+d+ '&riders=' + peeps) 
   ...
   var metroReq = $http.get('https://rubyline.herokuapp.com/estimates/train?lat='+a+'&long='+b)
     metroReq.then(
      function(data){
